...
namespace Assets.PLAYER_TWO.Platformer_Project.Scripts.PlayerLib
{
    public class PlayerStats : EntityStats<PlayerStats>
    {
        ...
        public float friction = 18f;           // 地面摩擦力
        ...
        //=====================【奔跑】===============================//
        [Header("Runing Stats")]
        public float runingAcceleration = 16f;      // 奔跑加速度
        public float runingTopSpeed = 9f;         // 奔跑最高速度
        public float runingTurningDrag = 14f;       // 奔跑转向阻尼

        //======================【跳跃】=============================//
        [Header("Jump Stats")]
        public int multiJumps = 1;                 // 允许的额外跳跃次数
        public float coyoteJumpThreshold = 0.15f; // 土狼跳判定时间
        public float maxJumpHeight = 17f;         // 最大跳高度
        public float minJumpHeight = 10f;         // 最小跳跃高度
        ...
        public float crawlinngTopSpeed = 2.5f;      // 爬行最高速度
        public float crawlingTurningSpeed = 3f;     // 爬行转向速度

        //====================【后空翻】=======================//
        [Header("Backflip Stats")]
        public bool canBackflip = true;                 // 是否能够后空翻
        public bool backflipLockMovement = true;        // 后空翻时是否能锁定移动
        ...
        public bool canAirSpin = true;          // 是否可以在空中旋转攻击
        public float spinDuration = 0.5f;       // 旋转攻击的持续时间
        public float airSpinUpwardForce = 10f;  // 空中旋转攻击时的上升力
        public int allowedAirSpins = 1;         // 允许空中旋转次数

        //==============【空中俯冲】===========================//
        [Header("Air Dive Stats")]
        public bool canAirDive = true;                  // 是否可以空中俯冲
        public bool applyDiveSlopsFactor = true;        // 是否考虑坡度因子
        public float airDiveForwardForce = 16f;         // 俯冲向前力
        public float airDiveFriction = 32f;             // 俯冲摩擦力
        public float airDiveSlopsFriction = 12f;        // 坡地摩擦力
        public float airDiveSlopUpwardForce = 35f;      // 上坡时的额外推力
        public float airDiveSlopDownwardForce = 40f;    // 下坡时的额外推力
        ...
        public float waterJumpHeight = 15f;         // 水中跳跃高度
        ...
        public LayerMask wallDragLayers;            // 可以进行滑行的层
        ...
        public float poleJumpDistance = 8f;     // 杆子跳水平速度
        ...
        public float minGrindInitialSpeed = 10f;    // 开始滑行的最小初速度
        ...
        public bool canGindDash = true;                 // 是否能在滑轨时冲刺
