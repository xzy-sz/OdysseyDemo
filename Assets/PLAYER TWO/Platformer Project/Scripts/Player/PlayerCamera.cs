...
namespace Assets.PLAYER_TWO.Platformer_Project.Scripts.PlayerLib
{
    ...
    public class PlayerCamera : MonoBehaviour
    {
        ...
        public float verticalUpDeadZone = .15f; // 在地面时。相机向上跟随的死区
        ...
        protected Vector3 m_cameraTargetPosition; // 相机目标位置

        protected Transform m_target; // 相机跟随的目标点

        protected string k_targetName = "Player Follower Camera Target"; // 临时目标对象的名称

        protected virtual void Start()
        {
            InitializeComponrnts();
            InitializeFollower();
            InitializeCamera();
        }
        ...
        /// 初始化组件
        /// </summary>
        protected virtual void InitializeComponrnts()
        {
            if (!player)
            {
        ...
        /// <summary>
        /// Unity 生命周期：每帧在LateUpdate 更新相机逻辑
        /// </summary>
