...
namespace Assets.PLAYER_TWO.Platformer_Project.Scripts.Entity
{
    ...
    /// 可绑定在实体或其他子物体上，监听特定状态的进入和退出事件，并触发对应的 UntityEvent;
    /// </summary>
    ...
    {
        /// <summary> 需要监听的状态名称列表，只监听这些状态的进入和退出。</summary>
        public List<string> states;

        /// <summary> 当进入指定状态时触发的事件 </summary>
        public UnityEvent onEnter;

        /// <summary> 当退出指定状态时触发的事件</summary>
        public UnityEvent onExit;

        /// <summary>持有的状态管理器引用，负责管理实体状态 </summary>
        ...
        /// </summary>
        /// <param name="state">进入状态的类型</param>
        ...
        /// <summary>
        /// 当状态管理器触发退出事件时调用
        /// 如果退出状态的名称包含在监听列表中，则触发 onExit UnityEvent.
        /// </summary>
