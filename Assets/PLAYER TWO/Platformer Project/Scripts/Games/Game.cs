...
namespace Assets.PLAYER_TWO.Platformer_Project.Scripts.Games
{
    ...
    /// </summary>
    [AddComponentMenu("PLAYER TWO/Platformer Project/Games/Game")]
    public class Game : Singleton<Game>
    {
        /// <summary>
        /// 当重试次数改变时触发，带有当前重试次数的参数
        /// </summary>
        ...
        public virtual GameLevel GetCurrentLevel()
        {
            ...
            return levels.Find((levels) => levels.scene == scene);
        }
