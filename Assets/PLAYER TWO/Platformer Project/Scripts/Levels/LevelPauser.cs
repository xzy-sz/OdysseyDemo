...
namespace Assets.PLAYER_TWO.Platformer_Project.Scripts.Levels
{
    ...
    {
        /// <summary> 当前关卡被暂停触发的事件</summary>
        public UnityEvent OnPause;

        /// <summary>当关卡被取消暂停触发的事件</summary>
        public UnityEvent OnUnpause;

        /// <summary>暂停界面的 UI 动画控制器</summary>
        public UIAnimator pauseScreen;

        /// <summary>是否允许暂停关卡</summary>
        public bool canPause { get; set; }

        /// <summary>当前关卡是否处于暂停状态</summary>
        ...
        /// 根据传入的值设置暂停状态
        /// </summary>
        /// <param name="value">true = 暂停</param>
