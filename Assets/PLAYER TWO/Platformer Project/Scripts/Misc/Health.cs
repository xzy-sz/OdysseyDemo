...
namespace Assets.PLAYER_TWO.Platformer_Project.Scripts.Misc
{
    ...
    public class Health : MonoBehaviour
    {
        ...
        /// <summary> 受伤后的冷却时间（在此时间内不会再次受到伤害） </summary>
        public float coolDown = 1f;

        /// <summary> 当生命值变化时调用的事件（比如 UI 更新） </summary>
        public UnityEvent onChange;

        /// <summary> 当对象受到伤害时调用的事件（比如播放受伤的动画，音效）</summary>
        public UnityEvent onDamage;

        /// <summary> 当前生命值 </summary>
        protected int m_currentHealth;

        /// <summary> 上一次受到伤害的时间 </summary>
